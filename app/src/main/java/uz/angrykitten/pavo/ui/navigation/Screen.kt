package uz.angrykitten.pavo.ui.navigation
...
sealed class Screen(val route: String) {
    ...
    data object AnimalDetail : Screen("animal_detail/{animalId}") {
        fun createRoute(id: String) = "animal_detail/$id"
    }
...
val bottomNavItems = listOf(
    BottomNavItem(Screen.Home, "Asosiy", Icons.Filled.Pets, Icons.Outlined.Pets),
